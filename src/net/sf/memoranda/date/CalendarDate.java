...
public class CalendarDate implements Comparable<CalendarDate> {
	...
	/**
	 * Retrieves the date that is a specified number of days from the original
	 * date
	 *
	 * @param distance
	 *            num of days from original date
	...
	public int hashCode() {
		int hashCode = 1;
		hashCode = 31 * hashCode + _year;
		hashCode = 31 * hashCode + _month;
		hashCode = 31 * hashCode + _day;
		return hashCode;
	}
