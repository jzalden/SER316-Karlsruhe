...
public class EventsTable extends JTable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6048680135713750761L;
	...
	public void initTable(CalendarDate d) {
		...
		case DAILY:
			dates = null;
			events = (Vector<Event>) EventsManager.getEventsForDate(d);
			break;
		case WEEKLY:
			...
			dates = new ArrayList<>();
			events = (Vector<Event>) EventsManager.getEventsForWeek(d, day, dates);
			break;
		case MONTHLY:
			dates = new ArrayList<>();
			events = (Vector<Event>) EventsManager.getEventsForMonth(d, dates);
			break;
		default:
			events = (Vector<Event>) EventsManager.getEventsForDate(d);
			break;
	...
	public TableCellRenderer getCellRenderer(int row, int column) {
		return new javax.swing.table.DefaultTableCellRenderer() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5673020127762407093L;
	...
	class EventsTableModel extends AbstractTableModel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -353701308073814125L;
