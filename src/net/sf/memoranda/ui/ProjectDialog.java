...
public class ProjectDialog extends JDialog {
	 ...
	 *
	 */
	private static final long serialVersionUID = -8189064024405726026L;
	...
	public static void newProject() {
		...
		// while confusing, in the constructor, project manager calls CurrentStorage.get().createProjectStorage(prj);
		// so it creates it, and then we will need to save it
		//
		// TODO: Fix this
