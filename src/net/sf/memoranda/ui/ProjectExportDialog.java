...
public class ProjectExportDialog extends JDialog {
	 ...
	 *
	 */
	private static final long serialVersionUID = 6315472160933944176L;
	...
	JComboBox<String> encCB = new JComboBox<String>(new String[] { Local.getString("System default"), "UTF-8", "ANSI" });
