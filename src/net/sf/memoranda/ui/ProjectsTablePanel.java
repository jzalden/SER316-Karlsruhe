...
public class ProjectsTablePanel extends JPanel {
	 ...
	 *
	 */
	private static final long serialVersionUID = 232708404011124198L;
	...
	public JTable projectsTable = new JTable() {
		 ...
		 *
		 */
		private static final long serialVersionUID = 387674229643722444L;
		...
		public TableCellRenderer getCellRenderer(int row, int column) {
			if (((String) getModel().getValueAt(row, PROJECT_ID)).equals(CurrentProject.get().getID())) {
				return new javax.swing.table.DefaultTableCellRenderer() {
					 ...
					 *
					 */
					private static final long serialVersionUID = 2421862255605069556L;
			...
			if ((row % 2) > 0) {
				return new javax.swing.table.DefaultTableCellRenderer() {
					 ...
					 *
					 */
					private static final long serialVersionUID = -5873113749846390607L;
	...
	class PrjTableModel extends AbstractTableModel {
		 ...
		 *
		 */
		private static final long serialVersionUID = -2326065191078987193L;
		String[] columnNames =
			{
