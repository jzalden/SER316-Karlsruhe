...
public class ResourcesPanel extends JPanel {
	 ...
	 *
	 */
	private static final long serialVersionUID = -5423344706648142535L;
	...
	void newResB_actionPerformed(ActionEvent e) {
		...
		if (dlg.localFileRB.isSelected()) {
			...
			if (!checkApp(mt))
				return;
			// if file is projectFile, then copy the file and change url.
	...
	boolean checkApp(MimeType mt) {
		...
		SetAppDialog dlg = new SetAppDialog(
				App.getFrame(),
