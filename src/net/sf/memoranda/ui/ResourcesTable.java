...
public class ResourcesTable extends JTable {
	 ...
	 *
	 */
	private static final long serialVersionUID = -3294391042916123610L;
	...
	public void initTable() {
		Vector<Resource> v = CurrentProject.getResourcesList().getAllResources();
	...
	public TableCellRenderer getCellRenderer(int row, int column) {
		return new javax.swing.table.DefaultTableCellRenderer() {
			 ...
			 *
			 */
			private static final long serialVersionUID = -3775846025096977709L;
	...
	class ResourcesTableModel extends AbstractTableModel {
		 ...
		 *
		 */
		private static final long serialVersionUID = 9108422191240190332L;
