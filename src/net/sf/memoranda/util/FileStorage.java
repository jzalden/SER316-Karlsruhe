...
public class FileStorage implements Storage {
	...
	public FileStorage() {
		/*
		 * The 'MEMORANDA_HOME' key is an undocumented feature for hacking the
		 * default location (Util.getEnvDir()) of the memoranda storage dir.
		 * Note that memoranda.config file is always placed at fixed location
		 * (Util.getEnvDir()) anyway
		 */
	...
	/**
	 * @see net.sf.memoranda.util.Storage#storeNoteList(net.sf.memoranda.NoteList,
	...
	/**
	 * @see net.sf.memoranda.util.Storage#storeResourcesList(net.sf.memoranda.ResourcesList,
	 *      net.sf.memoranda.Project)
	 */
